...
public class GetProductForDetailsController extends HttpServlet {

    Product productForDetails = null;
    Session sesija = null;
            ...
            try {
                ...
                transaction = sesija.beginTransaction();
                  ...
                  Query query = sesija.createQuery("from Product as product where product.id_product=" + Integer.parseInt(request.getParameter("id_product")));
                   ...
                   productForDetails = (Product)query.uniqueResult();
      
              request.setAttribute("productForDetails", productForDetails);
